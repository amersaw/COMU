...
/* while( !v1.empty() )                      // until vector is empty,
      {
      cout << v1.front() << ' ';              // display the firs element
      v1.pop_front();                         // remove the first element
      } */
      
     
//   v1.push_front(9);                         // remove the first element
      
      
      system("pause");                                      // output: 4.4 3.3 2.2 1.1
      return 0;
}
/*
